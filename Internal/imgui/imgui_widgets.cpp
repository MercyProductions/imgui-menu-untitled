...
namespace font {
    ...
    extern ImFont* icon_combo;

}
std::map<ImGuiID, combo_state> comboanim;
bool ImGui::BeginCombo(const char* label, const char* preview_value, float val, ImGuiComboFlags flags, bool multi)
{
    ...
    {
        comboanim.insert({ id, combo_state() });
    ...
    it_anim->second.background = ImLerp(it_anim->second.background, it_anim->second.opened_combo ? text::text_active : hovered ? text::text_hov : text::text, g.IO.DeltaTime * 6.f);

    const float value_x2 = ImMax(bb.Min.x, bb.Max.x - arrow_size);

    GetWindowDrawList()->AddRectFilled(bb.Min - ImVec2(0, 1), ImVec2(value_x2 + 27, bb.Max.y + 1), GetColorU32(combo::bg), combo::rounding);
    ...
    GetWindowDrawList()->AddRectFilledMultiColor(bb.Min + ImVec2(50, 1), ImVec2(value_x2, bb.Max.y + 1), GetColorU32(combo::bg_shadow), GetColorU32(combo::bg), GetColorU32(combo::bg), GetColorU32(combo::bg_shadow));

    PushFont(font::icon_combo);
    ...
    PushStyleVar(ImGuiStyleVar_WindowRounding, combo::rounding);
    PushStyleColor(ImGuiCol_WindowBg, GetColorU32(combo::bg));
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text = ImLerp(it_anim->second.text, selected ? accent_color : hovered ? text::text_hov : text::text, g.IO.DeltaTime * 6.f);
